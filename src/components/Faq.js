...
const data = {
    rows: [
        ...
        {
            title: <h2 style={{fontFamily: "Din", fontSize: "22px"}}>How much is a Trillionaire Thugs NFT?</h2>,
        ...
        {
            title: <h2 style={{fontFamily: "Din", fontSize: "22px"}}>When is the mint expected?</h2>,
        ...
        {
            title: <h2 style={{fontFamily: "Din", fontSize: "22px"}}>How can I mint?</h2>,
        ...
        {
            title: <h2 style={{fontFamily: "Din", fontSize: "22px"}}>On which network is Trillionaire Thugs?</h2>,
        ...
        {
            title: <h2 style={{fontFamily: "Din", fontSize: "22px"}}>How do I get whitelisted</h2>,
        ...
        {
            title: <h2 style={{fontFamily: "Din", fontSize: "22px"}}>How can I be part of the club?</h2>,
        ...
        {
            title: <h2 style={{fontFamily: "Din", fontSize: "22px"}}>How will Trillionaire Thugs be connected to the Metaverse?</h2>,
