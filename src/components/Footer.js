                    ...
                    <div className={window.innerWidth > 992 ? "col-12 footer--social-container" : "col-lg-6 col-12 footer--social-container"}>
                        <div className="social--wrapper" style={window.innerWidth > 992 ? {width: '10vw'} : {}}>
                            ...
                            <div className="d-flex align-items-center">
                                ...
                                <a className="blacck nav-link nav-link_icon" href="https://twitter.com/TThugsNFT" target="_blank" rel="noreferrer">
                                ...
                                <a className="blacck nav-link nav-link_icon" href="https://discord.gg/dRXdesRN63" target="_blank" rel="noreferrer">
                            ...
                            <a style={{width: "100%"}} className="nav-link nav-link_icon nav-link_icon-fluid rounded-3" href="https://discord.gg/dRXdesRN63" target="_blank" rel="noreferrer">
